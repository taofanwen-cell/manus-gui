...
> 覆盖 2026-09-06 ~ 2026-09-10 两个项目（携程机票查询 MVP / 拼多多竞品调研 API）共 67 条。
...
| D-11 | **模糊 fallback 不如明确报错** | 6 品牌同一份数据（B-20） |
| D-12 | **修完真 bug 就往本文档追加一条** | 同一个坑踩第二次 |
...
| `~/.workbuddy/MEMORY.md` | 跨项目硬规则（对应本文档第 10 章 D-1~D-12） |

**上次更新**：2026-09-10（Day9 Phase2 完成后整理，共 67 条）
